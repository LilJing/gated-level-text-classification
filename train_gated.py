...
parser.add_argument('--train-path', metavar='DIR',
                    help='path to training data csv', default='/home/jli/project/ag_news_csv/train.csv')
parser.add_argument('--val-path', metavar='DIR',
                    help='path to validation data csv', default='/home/jli/project/ag_news_csv/test.csv')
# learning
...
cnn.add_argument('--alphabet-path', default='character.json', help='Contains all characters for prediction')
...
cnn.add_argument('-highway-num', type=str, default=2, help='highway number')
# device
...
experiment.add_argument('--save-folder', default='models_word_char_high', help='Location to save epoch models, training configurations and results.')
...
def train(train_loader, dev_loader, model, args):
    ...
    for epoch in range(start_epoch, args.epochs+1):
        ...
        if args.checkpoint and epoch % args.save_interval == 0:
            file_path = '%s/word_char_CNN_epoch_%d.pth.tar' % (args.save_folder, epoch)
        ...
        if best_acc is None or val_acc > best_acc:
            file_path = '%s/word_charCNN_best.pth.tar' % (args.save_folder)
